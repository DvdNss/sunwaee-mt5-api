...
DEFAULT_ARGS = dict(
    ...
    train_csv_path='system/data/train.tsv',  # Training file path
    valid_csv_path='system/data/valid.tsv',  # Validation file path
    source_column='source_text',  # Source column
    target_column='target_text',  # Target column
    train_data_save_path='system/data/train.pt',  # Training data save path
    valid_data_save_path='system/data/valid.pt',  # Validation data save path
